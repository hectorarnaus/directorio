...
def crea_migas_negocio(negocio):
    res=(
        ...
        '<li style="display: flex; align-items: center;">\n'
            f'<a href="{dominio}/{sluguiza("Provincia de "+negocio.provincia)}" style="color: {color_base}; text-decoration: none; padding: 4px 10px; border-radius: 4px; transition: background 0.2s;">Provincia {negocio.provincia}</a>\n'
        '</li>\n'
        f'<li style="color: {color_contrast2};">/</li>\n'
        '<li style="display: flex; align-items: center;">\n'
...
def crea_migas_ciudad(ciudad,provincia):
    res=(
        ...
        f'<li style="color: {color_contrast2};">/</li>\n'
        '<li style="display: flex; align-items: center;">\n'
            f'<a href="{dominio}/{sluguiza("Provincia de "+provincia)}" style="color: {color_base}; text-decoration: none; padding: 4px 10px; border-radius: 4px; transition: background 0.2s;">Provincia {provincia}</a>\n'
        '</li>\n'
        f'<li style="color: {color_contrast2};">/</li>\n'
